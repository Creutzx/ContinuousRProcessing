...
all_cols <- c(rep('red',6), 
              "black", "#FF9B4C", "#7277C1", "#998B6B", "#C0C0C0", "#0528a8", 
              "black", "#FF9B4C", "#7277C1", "#998B6B", "#C0C0C0", "#0528a8")
names(all_cols) <- as.vector(outer(c('A','B','C','E', "NA", "D"), c('TRUE','FALSE',"NA"), 
                                   paste, sep=" "))
all_flls <- c("black", "#FF9B4C", "#7277C1", "#998B6B", "#C0C0C0", "#0528a8",
              "black", "#FF9B4C", "#7277C1", "#998B6B", "#C0C0C0", "#0528a8",
              "black", "#FF9B4C", "#7277C1", "#998B6B", "#C0C0C0", "#0528a8")
names(all_flls) <- as.vector(outer(c('A','B','C', 'E', "NA", 'D'), c('FALSE','TRUE',"NA"), 
                                   paste, sep=" "))
